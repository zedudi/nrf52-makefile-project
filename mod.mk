...
SDK_ROOT := $(realpath $(curdir)/NordicSDK_17.02/)
  
SOURCES := $(SOURCES) \
  $(realpath $(curdir)/system/gcc_startup_nrf52811.S)
...
# Linker flags
LDFLAGS := $(LDFLAGS) $(OPT)
LDFLAGS := $(LDFLAGS) -mthumb -mabi=aapcs -L$(SDK_ROOT)/modules/nrfx/mdk
LDFLAGS := $(LDFLAGS) -mcpu=cortex-m4
LDFLAGS := $(LDFLAGS) -Wl,--gc-sections
LDFLAGS := $(LDFLAGS) --specs=nano.specs
#LDFLAGS := $(LDFLAGS) -flto
LDFLAGS := $(LDFLAGS) -lc -lnosys -lm
...
flash: default $(OUTPUT_FILENAME).hex
	...
	nrfjprog -f nrf52 --program $(OUTPUT_FILENAME).hex --sectorerase --log
...
include $(realpath $(curdir)/ultimate-makefile/Makefile.ultimate)
undefine curdir
